...
public class CoolingEquation {
    DegCtoDegF converter = new DegCtoDegF();
        ...
        public double getTempChange(double tempEnv, double tempJacket) {
            ...
            double k =  0.00150;
            double givenTime = 1;
//            tempJacket = converter.degreeFtoC(tempJacket);
//            tempEnv = converter.degreeFtoC(tempEnv);
...
//            tempJacket = converter.degreeCtoF(tempJacket);
//            tempDec= converter.degreeCtoF(tempDec);
