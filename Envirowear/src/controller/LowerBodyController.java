...
public class LowerBodyController extends Controller {
    ...
    public void sensorSafetyCheck(){
        ...
        lowerBodySensor1.setTemp(safety.checkSensorNullTemp(lowerBodySensor1.getTemp()));
        lowerBodySensor2.setTemp(safety.checkSensorNullTemp(lowerBodySensor2.getTemp()));
        updateData();
    }
    ...
    private void updateData(){
        ...
        data.setLowerSensor1(lowerBodySensor1.getTemp());
        data.setLowerSensor2(lowerBodySensor2.getTemp());
    }
}
